...
def configure_group(session: ManagerSession, system_profile_id: UUID, transport_profile_id: UUID, service_profile_id: UUID) -> UUID:
    """
    ...
    group_id = session.api.config_group.create(
        ...
        solution="sdwan",
        profile_ids=[system_profile_id, transport_profile_id, service_profile_id],
    ).id
